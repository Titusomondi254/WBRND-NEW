...
<body>
    <div style="padding: 2rem; max-width: 1400px; margin: 0 auto;">
        ...
        <?php if(isset($success)): ?>
            <div class="alert alert-success">Γ£à <?= htmlspecialchars($success) ?></div>
        <?php endif; ?>

        <?php if(isset($error)): ?>
            <div class="alert alert-error">Γ¥î <?= htmlspecialchars($error) ?></div>
        <?php endif; ?>
                    ...
                    <div class="detail-row">
                        ...
                        <span class="detail-value">
                            <span class="status-badge status-<?= $user['kyc_verified'] ? 'active' : 'pending' ?>">
                                <?= $user['kyc_verified'] ? 'Γ£ô Verified' : 'ΓÅ│ Pending' ?>
                            </span>
                        </span>
                    </div>
                    <div class="detail-row">
